// NOW races
var race_now_augmented = new Race({
    name: 'Augmented',
    description: "Maybe there were complications in your infancy, or tragedy struck during your childhood; either way " +
...
var race_now_chosen = new Race({
    name: 'Chosen',
    description: "Something about you is better. Maybe you are the result of a sublime genetic match, perhaps your genome was " +
         "manipulated from before conception. How it is you came to be different is hardly important—how you are " +
         "different is everything. Some designed are much more likeable or beautiful than the average human, " +
         "others possess an evolved mental acuity, and some are sterling models of what biomechanics can achieve.\n\n" +
         "You might be characterized by prophecy and legend, and are often surrounded by stories or myths. Whether " +
         "you are part of a hereditary line, the touch of destiny graced upon you in the womb, you simply meet the " +
         "criteria listed in an old prophecy, or whether actual mysticism or magic is involved, you are special.",
    size: 'medium',
...
var race_now_mutant = new Race({
    name: 'Mutant',
    description: "You are different, your genetics a variation from the norm. This might be blatantly obvious with physical " +
         "deformities like albino skin, unnatural growths, discolored eyes, or asymmetrical features, or it may not " +
         "be immediately noticeable—regardless of the exact nature of your deviant genetics doesn’t matter, " +
         "but you must always take some action to hide it from society at large. Maybe you wear sunglasses to hide " +
         "your entirely black eyes, cover yourself in makeup and wear flesh-colored tights to conceal your horrific " +
         "skin, or wear extraneous clothing that hides your true nature.\n\n" +
