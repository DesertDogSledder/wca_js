...
var race_old_earth_nymph = {
    "name": "Earth Nymph",
    "description": "These nymphs arise from stone and soil in their many forms. The most common clan are the oreads, who embody mountains and caves. Earth nymphs can just as easily hail from valleys, particular stones, or underground mineral structures. Some even purport to be born of the stars.",
    "size": "medium",
    "available_skills": [
        "[magical]",
        "dancing",
...
var race_old_minotaur = {
    "name": "Minotaur",
    "description": "Imposing figures with the head of a bull and the body of a man, minotaurs are powerful, proud creatures. Typically the size and build of a tall, powerful human, minotaurs are incredible sailors, using their innate navigation prowess to sail the high seas. Minotaur pirates are feared, and Grand Elves traditionally have an enmity with the race, hunting down and bringing such pirates to justice.\n\nMinotaurs are arrogant, certain of their own superiority. However, they are also loyal - a minotaur will never break its word. Minotaurs are fond of tridents and nets, although many also choose to wield large and powerful axes. A minotaur will traditionally wear a kilt and a breastplate of iron or bronze.",
    "size": "medium",
    "available_skills": [
        "axes",
        "brawling",
