...
var race_new_human_belter = {
    "name": "Human Belter",
    "description": "Belters live on asteroids and low gravity worlds; some communities even exist in outer space, living on starships for generation after generation. Tall and spindly, they have adapted to move in zero-g, and are more flexible than those from Earth and similar planets.",
    "size": "medium",
    "available_skills": [
        "acrobatics",
        "appraisal",
...
var race_new_roden = {
    "name": "Roden",
    "description": "Roden, descended from rats, look as sly and shifty as their namesakes would suggest. Twitchy and nervous-looking, Roden have a fast metabolism and are rarely found not gnawing on something. Rodens tend to be scavengers and thieves.",
    "size": "small",
    "available_skills": [
        "[subterfuge]",
        "appraisal",
...
var race_new_simp = {
    "name": "Simp",
    "description": "Simps are uplifted chimpanzees. Agile and strong, they can climb and jump with ease. In space, they make excellent engineers, able to move easily in zero-g. Simps are shorter than humans, but stronger. Typically, a Simp stands about 4-5&apos; in height, with long arms, and is covered with black or brown fur. They can walk upright or they can walk on their knuckles when running. Simps are only one of many varieties of uplifted monkeys and apes.\n\nSimps sometimes have a bit of a chip on their shoulder regarding their ancestry. Their relationship with humankind has not been one of equals and, truth to tell, humankind still does not treat Simps as equals. This is compounded by the Simps&apos; natural tendency towards social hierarchies.",
    "size": "medium",
    "available_skills": [
        "acrobatics",
        "climbing",
...
var race_new_solurial = {
    "name": "Solurial",
    "description": "Solurials are large, plant-based creatures, able to convert solar energy directly thorugh the process of photosynthesis. They regard the devouring of animals and plants to be abhorrent and barabric. Patient, and slow to act, they are known for their artistic natures.",
    "size": "large",
    "available_skills": [
        "[artistic]",
        "[outdoor]"
...
var race_new_synthetic = {
    "name": "Synthetic",
    "description": "Synthetics are Androids. They look much like Humans (the earliest models were unconvincing, but today&apos;s models are almost indistinguishable). Designed to be non-threatening, Synthetics have a calm, passive demeanor. However, every Synthetic is different, with its own personality quirks. Synthetic are self-aware, but generally subservient to Humans.",
    "size": "medium",
    "available_skills": [
        "[academic]",
        "[artistic]",
...
var race_new_trantor = {
    "name": "Trantor",
    "description": "Descended from elephants, these sturdy beings feature trunks and tusks. Trantors are a very social, open people, who eat vast amounts and have extra-ordinary memories.\n\nTrantors are herbivores, and mainly consume vegetation. Generally cheerful, they are large humanoids, heavyset, and not known for their feats of dexterity.",
    "size": "large",
    "available_skills": [
        "carrying",
        "concentration",
