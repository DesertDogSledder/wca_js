// OLD races
var race_old_clockman = new Race({
    name: 'Clockman',
    description: "These sentient clockwork people tick quietly, an unnerving noise which can be heard by those who stand " +
         ...
         "A technically proficient scavenger race, clockmen have the unnerving ability to use their surroundings to " +
         "repair themselves. Damage a clockman, and it might pick up a nearby knife or fork, spare part, " +
         "or random trinket and use it to replace a damaged component. They can even use organic components, " +
         "meaning that many of them look particularly gruesome.\n\n" +
         ...
         "simply entering an untidy room will distress a clockman, who will likely being tiding it up immediately. If " +
         "they find broken objects, they feel the need to repair them.",
    size: 'medium',
...
var race_old_danuki = new Race({
    name: 'Danuki',
    description: "Danuki are spirit animals, at home in brush, hills, and ditches. Danuki are a small and very cowardly race. " +
    ...
    exploits: [{name: 'Masterful shapechanger',
              ...
              {name: 'Cowardly',
               desc: "Danuki are natural cowards. They must roll a 6 to shake off the Afraid condition. All danuki " +
                       ...
                       "danuki become Afraid. You should randomly select a phobia, or choose one with the GM’s " +
                       "approval."}]});

var race_old_deepling = new Race({
    name: 'Deepling',
    description: "Deeplings are a race of cursed beings, corrupted grand elves crossed with demonic ancestry. Hailing from a " +
         "magically-bereft nation, Deepling society is science-focused. In addition to the obvious horns and tails, " +
         "a Deepling's eyes are a deep solid yellow. Skin color varies from tan to a reddish hue.\n\n" +
         ...
         "and scholars.\n\n" +
         "Deeplings are fiercely opposed to superstition. Magic left them long ago, and they have turned their back " +
         "on old beliefs and religion. Deeplings believe that technology can achieve anything that magic - either " +
         "mortal or divine - can.",
    size: 'medium',
...
var race_old_earth_nymph = new Race({
    name: 'Earth Nymph',
    description: "These nymphs arise from stone and soil in their many forms. The most common clan are the oreads, " +
         "who embody mountains and caves. Earth nymphs can just as easily hail from valleys, particular stones, " +
         "or underground mineral structures. Some even purport to be born of the stars.",
    size: 'medium',
...
var race_old_forest_nymph = new Race({
    name: 'Forest Nymph',
    description: "Forest nymphs occur from woodlands and vegetation. Hamadryads are the spirits of individual trees, " +
         "and dryads are their aggregate forests. Whether they are distinct from or identical with the fey creature " +
         "that shares their name is anyone’s guess. Similar clans include flowers (anthousai), groves (alseides), " +
         "winds and breezes (aurae), and even the cardinal directions.",
    size: 'medium',
...
var race_old_goblin = new Race({
    name: 'Goblin',
    description: "Goblins are small goblinoids. Nasty, cunning, and scrappy, with poor hygiene, these creatures are looked " +
         "down upon by most sentient races. Goblins come from the deep, living underground in dark caverns in large " +
         "packs. They stand about 3 feet tall, with green skin and scrawny bodies. Their jagged, yellow teeth are " +
         "suited to tearing meat apart, and their yellow eyes are suited to seeing in the darkness of deep caverns " +
         "and caves.",
    size: 'small',
...
var race_old_grand_elf = new Race({
    name: 'Grand Elf',
    description: "Grand elves are an ancient race. Masters of gunpowder, there is nothing more awe-inspiring than the sight " +
         "of ranks of grand elves lined up with their muskets in the driving rain, felling row after row of charging " +
         "goblin hordes. Tall, pale, and serious, grand elves are strong believers in the good of the community being " +
         ...
         "Music is important to grand elves. Most are able to play one or more musical instruments, and singing comes " +
         "naturally to them. Their music is beautiful and ethereal.\n\n" +
...
var race_old_flint_dwarf = new Race({
    name: 'Flint Dwarf',
    description: "Crafted from an adaptable, yet flaky stone, Flint Dwarves are physically strong but emotionally volatile. " +
         "Flint Dwarves now dwell in isolated pockets of wilderness not claimed by anyone else and have come to be " +
         "known as “wild dwarves.”\n\n" +
         "The Flint Dwarves were instilled with the spirit of adaptability and survivability. They were given a " +
         "jovial temperament to serve as the mediators between dwarven tribes, but their mistreatment at the hands of " +
         "their kin has made the flint dwarves volatile and wild. While they are leaner and less sturdy than other " +
         "dwarves, they are still strong and stout-hearted. Yet, some dwarves were wary of their slim-featured " +
         "cousins, and decided they did not want the odd-looking, talkative flint dwarves to be their emissaries to " +
         "human lands, and banished them.\n\n" +
         "Today, Flint Dwarves can be found living in small stone huts in the wild areas of the world, " +
         "and their unkempt appearance suggests they have adapted well to their new homes.",
    size: 'small',
...
var race_old_jade_dwarf = new Race({
    name: 'Jade Dwarf',
    description: "In many lands, jade is valued as protection against corruption and disease. Jade Dwarves were created from " +
         "this stone as personification of this ability to withstand foul energies. Sometimes called “celestial” or " +
         "“exalted,” Dade Dwarves are rare and their holds are always found bordering regions that are cursed, " +
         "overrun with undead or fiends, or tainted in some other way. They are almost otherworldly in nature and " +
         "consider themselves the supreme guardians of civilization and all that is good.\n\n" +
         ...
         "approach all their creations with an equal measure of beauty. Jade Dwarf halls are immense structures of " +
         "unparalleled splendor.\n\n" +
         "Jade Dwarves view the people of the world as members of their clan, and they are willing to lay down their " +
         "lives for their family. Their society teaches that even the most depraved mortal can be redeemed, " +
         "but that monsters and beasts are beyond salvation.\n\n" +
         "A Jade Dwarf's skin can range from mint green to green-grey, and their dark eyes have no pupils. Their hair " +
         "varies from brown to grey, but can also be streaked with green, or totally dark green if they are member of " +
         "a noble house.",
    size: 'small',
...
var race_old_minotaur = new Race({
    name: 'Minotaur',
    description: "Imposing figures with the head of a bull and the body of a man, minotaurs are powerful, proud creatures. " +
         "Typically the size and build of a tall, powerful human, minotaurs are incredible sailors, using their " +
         "innate navigation prowess to sail the high seas. Minotaur pirates are feared, and Grand Elves traditionally " +
         "have an enmity with the race, hunting down and bringing such pirates to justice.\n\n" +
         "Minotaurs are arrogant, certain of their own superiority. However, they are also loyal - a minotaur will " +
         "never break its word. Minotaurs are fond of tridents and nets, although many also choose to wield large and " +
         "powerful axes. A minotaur will traditionally wear a kilt and a breastplate of iron or bronze.",
    size: 'medium',
...
var race_old_mountain_dwarf = new Race({
    name: 'Mountain Dwarf',
    description: "Mountain dwarves are a sturdy folk who live in great mountain strongholds. They have a love of treasure, " +
         ...
         "Mountain dwarves, like most dwarves, are stocky and broad. They stand about 4 feet tall; the males almost " +
         "invariably sport beards, while the females do not. They are stronger and tougher than humans, though they " +
         "lack grace and agility. Mountain dwarves are mortal; they live for about 250 years on average.\n\n" +
         "A reputation for greed follows all mountain dwarves. Almost every member of the race is born with an innate " +
         "appreciation of precious metals and rare gems, and much of their industry has historically been based " +
         "around these things.\n\n" +
...
var race_old_night_elf = new Race({
    name: 'Night Elf',
    description: "Their pale white skin reflects the moonlight. Their eyes are full of cruelty and deceit. They stalk the " +
         ...
         "Night elves are steeped in treachery; lies and deception are, to them, as natural as breathing. Life itself " +
         "has little value, and the lives of inferior races have none. Night elves, like their grand elf cousins, " +
         "were once no different to the sylvan elves of the woods and forests. When the sorcery and gunpowder cities " +
         "of the grand elves arose, the night elves were but a prominent house. Politics, divisions, and rivalries " +
         "took their course, and night elves today live apart from their cousins, feared and hated.\n\n" +
         "Lovers of darkness, worshipers of the moon, night elves are tall, thin, and have pale, white skin the color " +
         "of milk. Their eyes are coal-black, and their hair - when not decorated or dyed - is the purest white.",
    size: 'medium',
...
var race_old_obsidian_dwarf = new Race({
    name: 'Obsidian Dwarf',
    description: "The extremely tough and durable obsidian dwarves were created with hearts of basalt and magma flowing " +
         "through their veins. They were the first dwarves, but the Creator abandoned them in the primordial fires, " +
         "considering them a failed experiment.\n\n" +
         "All obsidian dwarves practice rituals that humans would call cannibalism. In its purest form, the Rites of " +
         "Consumption honor the fallen. Though the Rites are often misunderstood, obsidian dwarves do not eat the " +
         "flesh of intelligent creatures as an act of evil or intimidation; it is their way of honoring life, death, " +
         "and rebirth. Obsidian dwarves have no grave sites; family members are consumed by their clan and their " +
         "stony bones are displayed in their hall.\n\n" +
         "An obsidian dwarf's black skin is perfectly smooth and glassy, and flickers beautifully in firelight. Their " +
         "eyes reflect their fiery heritage, like black coals or scarlet embers. Their hair may be wild and tangled, " +
         "but can be dreadlocked, singed by fire, or ritually burned away.",
    size: 'small',
    intuition: 2, logic: 2,
...
var race_old_ogre = new Race({
    name: 'Ogre',
    description: "Ogres stand 7' tall. Towering masses of muscle, accompanied by green skin and bestial tusks, ogres have a " +
         "well-earned reputation for stupidity.\n\n" +
         "Ogres have greasy, lice-ridden black hair, and are often covered in warts and other blemishes. They smell " +
         "terrible, and an indescribable odor reminiscent of a mixture of stale sweat and rotting food.\n\n" +
         "Ogres are technically goblinoids, distantly related to orcs and goblins, but some giant blood was added in " +
         "the long past. They are brutish, prone to violence, and tend to act on instinct.\n\n" +
         "Ogre adventurers tend to be mercenaries and soldiers. Tribal in nature, those which have joined adventuring " +
         "outfits tend to curb their worst instincts and possess slightly higher intelligence than their wilder " +
         "brethren.\n\n" +
...
var race_old_orc = new Race({
    name: 'Orc',
    description: "Orcs are tribal, aggressive, violent, quick to anger and easy to offend. Strong and tough, orcs can be a " +
         "little slow on the uptake.\n\n" +
         "The warlike orcs have a barbaric, strength-based society. Orcs venerate warriors to the extreme, " +
         "and include violence in most social rituals. Orcs believe that those who die gloriously in battle are " +
         "guaranteed an afterlife of drinking, carousing, and fighting.\n\n" +
         "Orcs tend to be slightly taller, stronger, and broader than humans, with green skin and black hair. Their " +
         "ears are pointed, and some historians claim they are an ancient corrupted mockery of the elves. Like ogres, " +
         "they are goblinoids, perhaps with elven lineage in the distant past.\n\n" +
...
var race_old_smallfolk = new Race({
    name: 'Smallfolk',
    description: "Smallfolk are welcome in most places. Standing at about 3' in height, with ruddy cheeks and simple " +
         ...
         "Smallfolk favor simple clothes in bright colors. They tend towards the stout (though not nearly so much as " +
         "dwarves), and live to over 100 years of age. They boast pointed ears, although not as pronounced as those " +
         "of the elves, and frequently hidden by their curly hair.\n\n" +
         ...
         "towards violence, a cornered smallfolk will defend his or her friends to the death. In truth, smallfolk are " +
         "the most courageous of all races.\n\n" +
         "Typical names (male and female): Dobur, Thrari, Kirin, Borin, Boli, Filin, Gimnor, Thrarin, Dwain, Dolo, " +
         "Kibur.",
    size: 'small',
...
var race_old_sylvan_elf = new Race({
    name: 'Sylvan Elf',
    description: "Wild, fierce, and at one with nature, sylvan elves live in the woodlands and forests, armed with bow and " +
         "spear. Sylvan elves can be xenophobic at times, and are well-trained in the arts of both war and nature.\n\n" +
         ...
         "tinge. Unlike the grand elves, sylvan elves are not immortal. However, they have extremely long life spans " +
         "of up to two-thousand years.\n\n" +
         "Naturally magical, sylvan elves know the words and spells of the forest. They are known to talk to plants, " +
         "or to command animals. At home in the branches of trees, sylvan elves are also adept at hiding their " +
         "presence, and more than a few unwary intruders have found themselves ambushed upon entering sylvan " +
         "woodlands.\n\n" +
...
var race_old_water_nymph = new Race({
    name: 'Water Nymph',
    description: "Numerous legends report water nymphs leading foolish men to early ends; indeed, they are the most spirited " +
         "and mysterious. The kingdom of fresh water nymphs (naiads) include those who live in lakes (limnades), " +
         "rivers (potameides), streams, and fountains. Various salt water kingdoms include the oceans (oceanids) and " +
         "the seas (nereids), each with clans unknown to landborne races. There are also clans of frozen water nymphs " +
         "(icebergs, glaciers, snow) and airborne water nymphs (humidity, mist, stormclouds).",
    size: 'medium',
