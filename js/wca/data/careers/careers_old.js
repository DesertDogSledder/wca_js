var career_old_alchemist = {
    ...
    "availableExploits": [
        ...
        {
            "Name": "Healing potion",
            "Desc": "You can use your alchemy kit to heal 2d6 HEALTH in yourself or any creature you can touch. No creature may benefit from this more than once per day."
        },
        {
        ...
        },
        {
            ...
            "Desc": "(requires Healing Potion, alchemy 3) Your healing ability using your alchemy kit improves. You may now restore 3d6 HEALTH."
        },
        {
            "Name": "Concoction",
            "Desc": "Choose one status track. You can spend five minutes to create a concoction which, when drunk (and a MAG vs. the appropriate DEFENSE attack is made), moves the recipient one stage along that track. You may take this exploit multiple times, choosing a new status track each time."
        },
        {
            "Name": "Strong concoction",
            "Desc": "(requires Concoction, alchemy 3) One concoction you can create using the Concoction exploit now moves targets two stages along that status track."
        },
        {
            "Name": "Sticky concoction",
            "Desc": "(requires Concoction, alchemy 3) You may turn your concoction into a substance which can be delivered via a blade or an arrow. Apply an already-created concoction to an edged weapon. The next successful damaging attack made by that weapon will deliver the concoction to the target as though it had drunk it. This only lasts for one successful attack or for five minutes, whichever comes first."
        },
        {
            "Name": "Protective oil",
            "Desc": "You may spend 5 minutes to create a an oil which, when smeared over a creature, grants it SOAK 2 against one damage type. This is enough to protect against climate-based effects."
        }
    ],
    "stats": {
        "strength": 0,
...
var career_old_archer = {
    ...
    "availableExploits": [
        ...
        {
            "Name": "Bowyer",
            "Desc": "You know how to maintain your equipment. One standard quality bow becomes a high quality weapon, as long as you spend an hour maintaining it every day."
        },
        {
            "Name": "Careful aim",
            "Desc": "When aiming, your bonus to hit increases to +2d6."
        },
        {
            "Name": "Rapid shot",
        ...
        },
        {
            ...
            "Desc": "As long as you do not move, you can plant arrows in the ground and loose two shots every action."
        },
        {
            "Name": "Double shot",
...
var career_old_assassin = {
    ...
    "availableExploits": [
        ...
        {
            "Name": "Death blow",
            "Desc": "(requires Surprise Attack) Your damage bonus for attacking unaware targets increases to +4d6."
        },
        {
            "Name": "Poison resistance",
            "Desc": "You become resistant to poisons, gaining SOAK 5 poison and an additional die in your countdown die pool when poisoned."
        },
        {
            "Name": "Quiet kill",
            "Desc": "You are a master of silent death. Any target you kill during the ambush turn dies silently and without obvious visible signs. Nobody will notice that the target is dead for one minute, and will require a Strenuous [21] INT check to realize it thereafter."
        },
        {
            "Name": "Weak point",
            "Desc": "Once per enemy you may ignore any SOAK score it possesses by targeting a weak spot. You can never use this ability on the same enemy again."
        }
    ],
    "stats": {
        "strength": 0,
...
var career_old_barbarian = {
    ...
    "availableExploits": [
        ...
        },
        {
            ...
            "Desc": "You gain +5 to your MENTAL DEFENSE."
        },
        {
            "Name": "Primal charge",
            "Desc": "(requires Fleet of Foot) When charging, you howl and screech, moving twice your SPEED and gaining +2d6 to damage."
        },
        {
            "Name": "Hides &amp; skins",
            "Desc": "You know how to make the most out of basic gear. Hide armor worn by a barbarian counts as one quality level higher than it actually is."
        },
        {
            "Name": "Leathery skin",
            "Desc": "You gain +2 natural SOAK from hard, conditioned, leathery skin."
        },
        {
            "Name": "Iron skin",
            "Desc": "(requires Leathery Skin) Your natural SOAK bonus increases to +4."
        },
        {
            "Name": "Sacred terrain",
            "Desc": "Choose a terrain type, such as forest, plains, ocean, or mountains. When in that terrain, you gain a +1d6 to all dice pools; however, when not in that terrain, you suffer a -1d6 penalty to all dice pools."
        },
        {
            "Name": "Beastly visage",
            "Desc": "You have modified your body in various ways (scars, tattoos, piercings) as to make yourself as intimidating as possible. With a CHA vs. MENTAL DEFENSE attack, you can move a target who can see and hear you one stage along the Fear status track."
        },
        {
            "Name": "Scarred visage",
            "Desc": "(requires Beastly Visage, Leathery Skin) You are covered in scars. You are immune to the Bleeding status track."
        },
        {
            "Name": "Keen senses",
            "Desc": "You gain +1d6 to perception checks."
        },
        {
        ...
        },
        {
            ...
            "Desc": "You may spend two actions to make one melee attack against every adjacent foe. You cannot add additional exploits to these attacks."
        },
        {
            "Name": "Feral",
        ...
        },
        {
            ...
            "Desc": "(requires Sacred Terrain) In your chosen sacred terrain, you may pause for five minutes once per day, reflecting on nature and speaking to the Old Gods, to recover your full HEALTH."
        }
    ],
    "stats": {
        "strength": 1,
...
var career_old_berserker = {
    ...
    "availableExploits": [
        ...
        },
        {
            ...
            "Desc": "(requires Frenzy) When frenzied and wearing no armor, you gain a +4 MELEE DEFENSE bonus."
        },
        {
            "Name": "Regenerate",
            "Desc": "(requires Frenzy) Every time you deal a killing blow while frenzied you gain +1d6 HEALTH."
        },
        {
            "Name": "Fearless",
            "Desc": "(requires Frenzy) While frenzied, you are completely immune to the Fear status track."
        }
    ],
    "stats": {
        "strength": 1,
...
var career_old_burglar = {
    ...
    "availableExploits": [
        ...
        {
            "Name": "Grand heist",
            "Desc": "You achieve a great robbery that will be remembered for years to come. Gain a bonus 3d6 x 100gc. You may repeat this exploit, gaining 3d6x100gc each time."
        }
    ],
    "stats": {
        "strength": 0,
...
var career_old_diabolist = {
    ...
    "availableExploits": [
        ...
        {
            "Name": "Faustian pact",
            "Desc": "Your Faustian pact begins; but power comes at a price. You gain 2d6 additional Magic Points. Whenever you cast a spell, you take damage equal to the number of MP placed in that spell. However, you know that true power comes later to those who are patient."
        },
        {
            "Name": "Infernal mysteries",
            "Desc": "You learn the basics of diabolism. You gain the summoning, abjuration, and hexing skills at 1 rank (1d6) if you do not already have them, and learn the secret of demons."
        },
        {
            "Name": "Imp",
            "Desc": "You gain an imp familiar which will do your bidding. It will undertake dangerous tasks, but to persuade it to do something suicidal (or near-so) requires a Difficult [16] CHA check; if you fail, your imp betrays you."
        }
    ],
    "stats": {
        "strength": 0,
...
var career_old_druid = {
    ...
    "availableExploits": [
        ...
        },
        {
            ...
            "Desc": "You gain an animal companion in the form of a wolf. This companion will accompany and defend you. If your companion dies, you attract a new companion in one month. However, if you abuse your companion (for example by sending it ahead to set off traps), it will leave you and you will never be able to replace the companion. The companion is bright for its species, but has no special intelligence or abilities. You may take this exploit multiple times, gaining an extra animal companion each time."
        },
        {
            "Name": "Ageless",
            "Desc": "(requires Poison Immunity) You no longer age and become effectively immortal, saving accidental death."
        },
        {
            "Name": "Beast form",
        ...
        {
            "Name": "Companion link",
            "Desc": "(requires Animal Companion) You gain a telepathic link with your animal companion with a range of 1 mile; this enables you to send it instructions and to see through its eyes."
        },
        {
        ...
        {
            "Name": "Nature priest",
            "Desc": "You gain the secret of beasts and the secret of plants."
        },
        {
            "Name": "Poison immunity",
            "Desc": "You become immune to all poisons and poison damage."
        },
        {
            "Name": "Speak with animals",
            "Desc": "You may freely speak with animals, although they do not gain special intelligence or knowledge."
        }
    ],
    "stats": {
        "strength": 0,
...
var career_old_firemage = {
    ...
    "availableExploits": [
        ...
        {
            "Name": "Fire immunity",
            "Desc": "(requires Fire Resistance) You become completely immune to fire or heat damage. Your vulnerability to cold, however, increases to 2d6."
        },
        {
            "Name": "Fire resistance",
            "Desc": "You permanently gain SOAK 5 (fire). However, you also suffer Vulnerability (1d6) to cold."
        },
        {
            "Name": "Firesculptor",
        ...
        {
            "Name": "Flaming aura",
            "Desc": "(requires Flaming Touch) You gain an aura (based on your size as normal) of flame and heat, although you may suppress it easily. Creatures entering or starting a turn in this aura take 2d6 fire damage."
        },
        {
            "Name": "Flaming touch",
            "Desc": "Your touch becomes hot enough to injure others, causing an additional 1d6 of heat damage beyond your natural damage."
        },
        {
            "Name": "Sticky fire",
            "Desc": "Every time you damage a foe with fire, they are pushed one stage down the fire status track."
        }
    ],
    "stats": {
        "strength": 0,
...
var career_old_gladiator = {
    ...
    "availableExploits": [
        ...
        {
            "Name": "Unusual weapon",
            "Desc": "Choose one of the following weapons: trident, net, spear. Weapons of that type count as one quality level higher when you use them."
        },
        {
            "Name": "Signature move",
        ...
        {
            "Name": "Fake wounds",
            "Desc": "Once per day, you may use your expertise in faking injuries to turn an actual blow into a pretend one. Your opponent, and all onlookers, will believe you have suffered the damage inflicted by the attack, but in fact it causes no damage at all."
        },
        {
            "Name": "Surprise recovery",
            "Desc": "(requires Fake Wounds) After using your Fake Wounds ability, you may make a single free melee attack at any point up until you make an actual regular melee attack. The free attack must be your first melee attack since using the Fake Wounds ability."
        }
    ],
    "stats": {
        "strength": 0,
...
var career_old_herbalist = {
    ...
    "availableExploits": [
        ...
        },
        {
            ...
            "Desc": "You can automatically devise an herbal concoction to remove any condition instantly (stunned, blinded, and so on) by mixing the herbs you have on you and adding additional components from your surroundings as long as you have your herbalism kit on you. This takes two actions (a full turn) and reduces any status track by one stage automatically."
        },
        {
            "Name": "Herbal ward",
        ...
        {
            "Name": "Stimulant",
            "Desc": "You can create a herbal mixture which increases the die pool of one attribute by 1d6 for five minutes. You must choose the attribute when you select this exploit; you may select it multiple times and choose a different attribute each time. It takes one minute to create the mixture."
        },
        {
            "Name": "Depressant",
            "Desc": "You can create a herbal mixture which decreases the die pool of one attribute by 1d6 for five minutes. You must choose the attribute when you select this exploit; you may select it multiple times and choose a different attribute each time. It takes one minute to create the mixture."
        }
    ],
    "stats": {
        "strength": 0,
...
var career_old_inquisitor = {
    ...
    "availableExploits": [
        ...
        },
        {
            ...
            "Desc": "You gain SOAK 5 (magic). This applies to any damage caused directly by magic; it does not apply to indirect damage."
        },
        {
            "Name": "Sense magic",
...
var career_old_knight = {
    ...
    "availableExploits": [
        ...
        {
            "Name": "Honorable",
            "Desc": "Your courage and honor are such that you automatically succeed in attempts to shake off Fear status track effects."
        },
        {
            "Name": "Squire",
            "Desc": "(requires Bonded Mount) You gain a free squire. You must protect your squire; in exchange, one weapon or one suit of armor you possess increases by one quality level (to a maximum of artisan). If your squire dies, he is replaced in one month."
        }
    ],
    "stats": {
        "strength": 1,
...
var career_old_loremaster = {
    ...
    "availableExploits": [
        ...
        {
            "Name": "Experienced",
            "Desc": "Your knowledge and expertise borders on the prophetic. Your entire party gains a +1d6 INITIATIVE bonus if they are within 30 feet of you when they make their check."
        },
        {
            "Name": "Identify",
        ...
        {
            "Name": "Language lore",
            "Desc": "You gain the scholastic ability to speak or read any unknown language with a Difficult [16] INT check."
        },
        {
            "Name": "Language mastery",
            "Desc": "(requires Language Lore) You can now speak or read any unknown language automatically."
        },
        {
            "Name": "Anatomist",
            "Desc": "You automatically know the resistances and vulnerabilities of any creature you encounter."
        },
        {
            "Name": "Wise counsel",
        ...
        {
            "Name": "Ritual",
            "Desc": "You can cast a specific spell of 3 MP or less as a ritual; this takes one minute per MP, but costs no MP. Devise one spell and note it down. You may take this exploit more than once, creating a new ritual each time."
        },
        {
            "Name": "Greater ritual",
...
var career_old_mage = {
    ...
    "availableExploits": [
        ...
        },
        {
            ...
            "Desc": "Choose four [magical] skills and one element secret. You gain these four skills at 1 rank (1d6). This does not increase the rank of an existing skill."
        },
        {
            "Name": "Arcane secret",
            "Desc": "You have learned or discovered an arcane secret - either an element, creature type, or virtue. You can take this exploit multiple times, learning a new secret each time, but you may know no more secrets than your LOG attribute."
        },
        {
            "Name": "Attuned",
        ...
        {
            "Name": "Familiar",
            "Desc": "You gain a familiar, which is a tiny-sized creature (cat, bat, owl, mouse, rat, etc.) You can speak to your familiar, which is able to report back things it has seen or heard."
        },
        {
            "Name": "Learned",
        ...
        {
            "Name": "Specialization",
            "Desc": "(requires Arcane Knowledge Base) Choose one secret that you already know. You are specialized in that secret. You may exceed your MAG attribute by 2 points when using that secret. You may only ever specialize in one secret."
        }
    ],
    "stats": {
        "strength": 0,
...
var career_old_man_at_arms = {
    ...
    "availableExploits": [
        ...
        {
            "Name": "Hold the line",
            "Desc": "When standing adjacent to an ally, you both gain a 1d6 cover bonus."
        },
        {
            "Name": "Advance!",
        ...
        {
            "Name": "Shield-bearer",
            "Desc": "Any shield you wear increases its DEFENSE bonus by +4."
        },
        {
            "Name": "Shield wall",
            "Desc": "When standing between two allies, all three gain a +2d6 cover bonus. This does not stack with itself or with Hold the Line."
        }
    ],
    "stats": {
        "strength": 1,
...
var career_old_musketeer = {
    ...
    "availableExploits": [
        ...
        {
            "Name": "Musket charge",
            "Desc": "When charging with a melee weapon, you may begin your charge with a single musket shot, switch weapons, charge, and end it with a single melee strike."
        },
        {
            "Name": "Pistol-whip",
            "Desc": "You can use a firearm as a club by striking with the butt once per turn as a free action as long as you are currently wielding only that weapon."
        },
        {
            "Name": "Swashbuckler",
            "Desc": "Your swashbuckling swordplay gives you any two of the following universal exploits: Disarm, Sidestep, Taunt."
        },
        {
...
var career_old_necromancer = {
    ...
    "availableExploits": [
        ...
        },
        {
            ...
            "Desc": "You gain the skills of summoning, affliction, and creation at a rank of 1 (1d6) if you do not already have them. You also gain the secrets of death and shadow."
        },
        {
            "Name": "One of us",
            "Desc": "(requires Corpse Visage) Undead of a lower grade than yourself are unable to attack or harm you in any way."
        },
        {
            "Name": "Touch of the grave",
            "Desc": "Your touch gains the foulness of death, doing an additional 1d6 death damage. You also kill any small (non creature) plants you come into contact with."
        },
        {
            "Name": "Undead servant",
            "Desc": "You gain an undead slave \u2013 a skeleton or zombie \u2013 which obeys your every command until destroyed. If destroyed, you may summon a new one with a 24 hour ceremony and access to an appropriate corpse. You may take this exploit multiple times, gaining a new servant each time."
        },
        {
            "Name": "Undeath",
        ...
        {
            "Name": "Vampiric touch",
            "Desc": "(requires Touch of the Grave) You are able to steal the life essence of a victim for yourself. When you use your Touch of the Grave to do damage to another creature, you gain that amount of HEALTH."
        }
    ],
    "stats": {
        "strength": 0,
...
var career_old_pirate = {
    ...
    "availableExploits": [
        ...
        {
            "Name": "Hook",
            "Desc": "One of your hands is now a hook. You are always considered to be carrying a knife. You also gain a bonus +1 REP."
        },
        {
            "Name": "Keelhauled",
        ...
        {
            "Name": "Rigging",
            "Desc": "You do not suffer penalties for fighting while climbing."
        },
        {
        ...
        {
            "Name": "Polly",
            "Desc": "You gain a small bird (crow, parrot, owl, etc.) as an animal companion. See the druid career for information on animal companions."
        },
        {
...
var career_old_ranger = {
    ...
    "availableExploits": [
        ...
        {
            "Name": "Traveller",
            "Desc": "You are skilled at wilderness travel, at home under the open sky. You increase the travel increment of a group you lead by one day. You may take this exploit multiple times, increasing the travel increment by one day each time."
        },
        {
        ...
        },
        {
            ...
            "Desc": "You can speak to animals. This does not grant them special knowledge or intelligence, so the information you can gain is limited by their own capabilities. Neither does it guarantee friendship or cooperation."
        }
    ],
    "stats": {
        "strength": 0,
...
var career_old_sailor = {
    ...
    "availableExploits": [
        ...
        {
            "Name": "Sea legs",
            "Desc": "You adapt to the motion of a ship; this makes you very hard to knock down. When you are knocked prone, you may make a Challenging [13] AGI check; if you succeed, you remain standing."
        },
        {
            "Name": "Grog",
            "Desc": "While you may well enjoy a drink, you never suffer any penalties from intoxication via alcohol."
        },
        {
            "Name": "Swimmer",
        ...
        {
            "Name": "Sea shanty",
            "Desc": "By singing a sea shanty, a sailor can combat sickness and tiredness. Anyone who hears the shanty is reduced by one stage in the Nausea or Tiredness status tracks (the sailor must choose which of the two songs he is singing)."
        },
        {
            "Name": "Any port",
            "Desc": "You may take this exploit multiple times. Each time you take it, you may designate an additional port town. At that location, you will have one contact upon whom you can (generally) rely, and one tavern at which you can drink for free."
        },
        {
            "Name": "Lookout",
        ...
        {
            "Name": "Peg leg",
            "Desc": "One of your legs is a wooden peg. You are used to it, so it does not negatively affect you; you gain a kick attack which increases your unarmed damage by 1d6."
        }
    ],
    "stats": {
        "strength": 0,
...
var career_old_smith = {
    ...
    "availableExploits": [
        ...
        },
        {
            ...
            "Desc": "You are able to identify rare or magical weapons and armor without making an attribute check."
        },
        {
            "Name": "Chink in the armor",
            "Desc": "You know armor, and its styles well, including the weaknesses of each type. Once per suit of armor, you may ignore its SOAK value when attacking."
        },
        {
            "Name": "Forge",
            "Desc": "(requires weaponsmithing or armorer) You forge yourself a single standard quality weapon (weaponsmithing) or suit of armor (blackmithing), which you gain for free."
        },
        {
            "Name": "Quality forge",
            "Desc": "(requires Forge; weaponsmithing 4 or armorer 4) You forge yourself a single high quality weapon (weaponsmithing) or suit of armor (blackmithing); you must pay for the standard quality version, but it becomes high quality automatically."
        },
        {
            "Name": "Exceptional forge",
            "Desc": "(requires Quality Forge; weaponsmithing 7 or armorer 7) You forge yourself a single exceptional quality weapon (weaponsmithing) or suit of armor (blackmithing); you must pay for the standard quality version, but it becomes exceptional quality automatically. You may repeat this exploit."
        },
        {
            "Name": "Master forge",
            "Desc": "(requires Exceptional Forge; weaponsmithing 10 or armorer 10) You forge yourself a single mastercraft quality weapon (weaponsmithing) or suit of armor (blackmithing); you must pay for the standard quality version, but it becomes mastercraft quality automatically. You may repeat this exploit."
        },
        {
            "Name": "Artisanal forge",
            "Desc": "(requires Master Forge; weaponsmithing 12 or armorer 12) You forge yourself a single artisanal quality weapon (weaponsmithing) or suit of armor (blackmithing); you must pay for the standard quality version, but it becomes artisanal quality automatically. You may repeat this exploit."
        },
        {
            "Name": "Legendary forge",
            "Desc": "(requires Artisinal Forge; MAG 3+;; weaponsmithing 15 or armorer 15) You forge yourself a single legendary quality weapon (weaponsmithing) or suit of armor (blackmithing); you must pay for the standard quality version, but it becomes legendary quality automatically. You may repeat this exploit."
        },
        {
            "Name": "Alchemical weapon",
            "Desc": "(requires Master Forge, Sticky Concoction, MAG 4+) You combine the Sticky Concoction ability from the Alchemist career and Master Forge or greater from the Smith career, the weapon you created permanently gains the effect granted by the Sticky Concoction. You may repeat this exploit."
        },
        {
            "Name": "Alchemical armor",
            "Desc": "(requires Exceptional Forge, Protective Oil, MAG 2+) You combine the Protective Oil ability from the Alchemist career and Exceptional Forge or greater from the Smith career, the armor you created permanently gains the extra protection granted by the Protective Oil. You may repeat this exploit."
        }
    ],
    "stats": {
        "strength": 1,
...
var career_old_undead_hunter = {
    ...
    "availableExploits": [
        ...
        {
            "Name": "Divine Strike</strong>. Your attacks do Good damage to the undead.</li><li><strong>Holy Symbol",
            "Desc": "(requires Turn Undead) Brandishing your holy symbol aloft, your Turn Undead ability now pushes the undead two steps along the Fear status track."
        },
        {
        ...
        {
            "Name": "Special Enemy",
            "Desc": "(requires Lore of the Dead) Choose one type of undead. You become known as a hunter of that type of undead (e.g. a Vampire Hunter), and gain +2 REP. You automatically ignore any natural SOAK that that creature possesses (although not armor SOAK)."
        },
        {
            "Name": "Stalwart",
            "Desc": "You become immune to fear effects caused by the undead."
        },
        {
...
var career_old_warrior_monk = {
    ...
    "availableExploits": [
        ...
        {
            "Name": "Iron fist",
            "Desc": "Your unarmed damage increases by 1d6."
        },
        {
            "Name": "Martial leap",
        ...
        },
        {
            ...
            "Desc": "When using any Oriental weapon, you gain one free unarmed melee atatck whenever you make two weapon attacks."
        },
        {
            "Name": "Drunken fist",
            "Desc": "When intoxicated through alcohol, you gain +4 to your MELEE DEFENSE. This does not stack with Defensive Stance."
        },
        {
            "Name": "Iron skin",
            "Desc": "Your training grants you +2 natural SOAK."
        },
        {
            "Name": "Elemental fist",
            "Desc": "(requires Iron Fist, MAG 2+) Your fist is surrounded by the glow of elemental energy. The damage type becomes heat, and does an additional +1d6 damage."
        },
        {
            "Name": "Mountain stance",
            "Desc": "(requires Defensive Stance) You become as immobile as a mountain. No knockdown or knockback attempt by a creature of your size or smaller will work against you."
        },
        {
            "Name": "Zen mind",
            "Desc": "You gain +4 to your MENTAL DEFENSE."
        }
    ],
    "stats": {
        "strength": 0,
...
var career_old_watchman = {
    ...
    "availableExploits": [
        ...
        {
            "Name": "Chaser",
            "Desc": "When chasing someone, your SPEED increases by +2."
        },
        {
            "Name": "Clues",
            "Desc": "If there are clues to be discovered at the scene of a crime, you automatically find them within 5 minutes."
        },
        {
            "Name": "Sap",
            "Desc": "You gain a special sap attack, used to knock out and apprehend criminals. You use any weapon; you do no damage, but a successful attack pushes the target along the Alertness status track by one stage for each 5 points of damage you would have done."
        },
        {
            "Name": "Troublesense",
            "Desc": "You are able to spot trouble before it happens. You gain a +1d6 bonus to INITIATIVE checks."
        }
    ],
    "stats": {
        "strength": 0,
...
var career_old_dict = {
    "career_old_alchemist": career_old_alchemist,
    "career_old_archer": career_old_archer,
    "career_old_assassin": career_old_assassin,
    "career_old_barbarian": career_old_barbarian,
    "career_old_berserker": career_old_berserker,
    "career_old_burglar": career_old_burglar,
    "career_old_cleric": career_old_cleric,
    "career_old_diabolist": career_old_diabolist,
    "career_old_druid": career_old_druid,
    "career_old_firemage": career_old_firemage,
    "career_old_gladiator": career_old_gladiator,
    "career_old_herbalist": career_old_herbalist,
    "career_old_inquisitor": career_old_inquisitor,
    "career_old_knight": career_old_knight,
    "career_old_loremaster": career_old_loremaster,
    "career_old_mage": career_old_mage,
    "career_old_man_at_arms": career_old_man_at_arms,
    "career_old_minstrel": career_old_minstrel,
    "career_old_musketeer": career_old_musketeer,
    "career_old_necromancer": career_old_necromancer,
    "career_old_pirate": career_old_pirate,
    "career_old_prisoner": career_old_prisoner,
    "career_old_ranger": career_old_ranger,
    "career_old_ruffian": career_old_ruffian,
    "career_old_sailor": career_old_sailor,
    "career_old_smith": career_old_smith,
    "career_old_squire": career_old_squire,
    "career_old_undead_hunter": career_old_undead_hunter,
    "career_old_warrior_monk": career_old_warrior_monk,
    "career_old_watchman": career_old_watchman,
}