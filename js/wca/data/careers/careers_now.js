var career_now_actor = new Career(
    ...
    available_exploits=[{'Name': 'Box-office star',
                         'Desc': "(requires B-movie) You were in a blockbuster movie. You gain reputation=2 and begin " +
                                 ...
                                 "(1d6). Name your movie."},
                        {'Name': 'Method actor',
                         'Desc': "You immerse yourself into your roles. Increase your acting skill to 6 ranks."},
                        {'Name': 'Stage-fright',
                         'Desc': "You learned to overcome your nerves on the stage. Once per day you may ignore a " +
                                 "fear-based effect."},
                        {'Name': 'Costumer',
...
var career_now_archaeologist = new Career(
    ...
    available_exploits=[{'Name': 'Not another trap', 'Desc': "You can spend a LUC die to automatically avoid a trap."},
                        ...
                        {'Name': 'Antique',
                         'Desc': "You start play with an antique weapon, which is of exceptional quality."},
...
var career_now_bouncer = new Career(
    ...
    available_exploits=[{'Name': 'Immovable object',
                        ...
                        {'Name': 'Quick-search',
                         'Desc': "You are adept at spotting concealed weapons, drugs, and other things. You " +
                                 "automatically spot hidden items concealed about somebody's person."},
                        {'Name': 'Age-check',
                        ...
                        {'Name': 'Pin',
                         'Desc': "You know how to pin somebody in place. Make a melee attack against an adjacent " +
...
var career_now_boxer = new Career(
    ...
    available_exploits=[{'Name': 'One-two',
                        ...
                        {'Name': 'Haymaker',
                         'Desc': "With a wild swing, you pool all your attack potential into one mighty blow. The " +
                                 "attack costs two actions, suffers a -2d6 penalty to hit, but deals double damage. " +
                                 "If you miss, however, you put yourself at a disadvantage, allowing your opponent an " +
                                 "immediate free attack at you."},
                        {'Name': 'Beat the count',
                         'Desc': "Once per day, when reduced to 0 health, you may spend two actions to recover 2d6 " +
                                 "health and stand up."},
                        {'Name': 'Rope-a-dope',
                         'Desc': "You allow your enemy to attack you, fooling him into believing he is winning. You " +
                                 "allow the enemy's next two attacks to strike home, choosing to receive the damage; " +
                                 "after the second attack, you respond with a counterattack which does bonus damage " +
                                 "equal to the damage he dealt you."},
                        {'Name': 'K.O.',
                         'Desc': "(requires Haymaker)  A mighty blow fells your opponent, knocking him to the ground " +
                                 "and stunning him until he shakes that condition off."},
                        {'Name': 'Bare Knuckles',
                         'Desc': "Not every fight is in a well-lit ring with ropes, medical staff, or even gloves—and " +
                                 "you know that better than anyone. People have been tangling with you in back " +
                                 "alleys, bars, and maybe even prison yards, fist for fist, for years. Your boxing " +
...
var career_now_chef = new Career(
    ...
    available_exploits=[{'Name': 'Cooking knives',
                        ...
                        {'Name': 'Poison resistance',
                         'Desc': "You often have to taste your food, and you have developed SOAK 5 vs. poisons."},
                        {'Name': 'Poisoner',
                         'Desc': "You know how to make a poison. It takes you five minutes, and lasts for one hour " +
                                 "before becoming ineffective. Your poison does poison damage equal to your LOG dice " +
                                 "pool when ingested."},
                        {'Name': 'Kitchen management',
                         'Desc': "Running a kitchen is a gruelling job. You know how to get the most out of your " +
                                 "underlings, even if you have to shout profanities at them. One per day you may " +
                                 "spend two actions to give all allies within 30' one immediate free action."},
                        {'Name': 'A good meal',
...
var career_now_college = new Career(
    ...
    available_exploits=[{'Name': 'Bachelor',
                         'Desc': "After a four-year course, you gained a Bachelor's degree or equivalent at " +
                                 ...
                                 "you gain a +1d6 bonus to attempts to learn information about a subject. Make a " +
                                 "Challenging [13] LOG check before advancing any attributes. If you succeed, " +
                                 "you pass this degree with honors and gain 1 bonus REP attribute point."},
                        {'Name': 'Masters [requires Bachelor]',
                         'Desc': "You remain in college and gain a Masters degree in your subject. You gain 1 bonus " +
                                 "skill rank in your chosen subject. Make a Difficult [16] LOG check before advancing " +
                                 "any attributes. If you succeed, you pass this degree with honors and gain 1 bonus " +
                                 "REP attribute point."},
                        {'Name': 'Doctorate [requires Masters]',
                         'Desc': "After further studies, you gained a Doctorate at university. You may now call " +
                                 "yourself a Doctor. But not THE Doctor. Gaining a doctorate requires not just an " +
                                 "expert knowledge of a subject, but also rigorous skills of analysis and evaluation " +
                                 "and critical achievement. Improve your skill ranks in your chosen subject to 6. " +
...
var career_now_con_artist = new Career(
    ...
    available_exploits=[{'Name': 'Grifter',
                        ...
                        {'Name': 'Impersonate',
                         'Desc': "You are easily able to impersonate any job role which you have had opportunity to " +
                                 "observe within the past day, even briefly. You gain a +1d6 bonus if you have been " +
                                 "able to observe and mimic an example."},
                        {'Name': 'Quick change',
                         'Desc': "You are able to don a quick disguise in one round instead of five minutes. This " +
                                 "must be a disguise you've successfully used before."},
                        {'Name': 'Beguiling',
...
var career_now_cultist = new Career(
    ...
    available_exploits=[{'Name': 'Devotion',
                         'Desc': "You are utterly devoted to your cause. Your single-mindedness grants you +4 MENTAL " +
                                 "DEFENSE."},
                        {'Name': 'Occultist',
                         'Desc': "You have knowledge of the paranormal; things that were not meant to be known."},
                        {'Name': 'Sacrificial dagger',
                         'Desc': "You start play with a high quality dagger with either the Serrated Blade or the " +
                                 "Sharpened customization."},
                        {'Name': 'Poison resistance',
...
var career_now_dark_crusader = new Career(
    ...
    available_exploits=[{'Name': 'Dark knight',
                         'Desc': "You operate best at night, knowing how to use the shadows to your advantage. Once " +
                                 ...
                                 "one minute."},
                        {'Name': 'Fearful legend',
                         'Desc': "Criminals fear you, and rightly so. You may make a REP vs. MENTAL DEFENSE attack to " +
                                 "inflict the frightened condition on a target until they shake it off."},
                        {'Name': 'Vanish.',
                         'Desc': "You are renowned for your ability to simply disappear; some even believe it to be " +
                                 "supernatural. Once per day, during the hours of darkness, you may effectively turn " +
                                 "invisible until you attack."},
                        {'Name': 'Utility belt', 'Desc': "You gain one gadget of your choice."},
                        {'Name': 'Costume.',
                         'Desc': "You gain a costume which acts as armor with SOAK 8. This special costume does not " +
...
var career_now_detective = new Career(
    ...
    available_exploits=[{'Name': 'Clues',
                        ...
                        {'Name': 'Criminal record',
                         'Desc': "You can freely access police databanks and automatically discover any information " +
...
var career_now_diplomat = new Career(
    ...
    available_exploits=[{'Name': 'Diplomatic',
                        ...
                        {'Name': 'Diplomatic pouch',
                         'Desc': "You have a diplomatic pouch in which any small sized item can be carried through " +
                                 "customs without inspection."},
                        {'Name': 'Embassy',
                         'Desc': "You have access to your home country's ambassadorial embassy and residences in any " +
                                 "country (if there are any), which can provide food, shelter, basic equipment, " +
                                 "and medical care."},
...
var career_now_engineer = new Career(
    ...
    available_exploits=[{'Name': 'Technical knowledge base',
                         'Desc': "Choose four [technical] skills. You gain these four skills at 1 rank (1d6). This " +
                                 "does not increase the rank of an existing skill."},
                        {'Name': 'Jury-rig',
                         'Desc': "You can temporarily repair and jury-rig a broken item of size Medium or smaller by " +
                                 "spending five minutes with it. The item will operate for a number of minutes equal " +
                                 "to your LOG check. If you spend one hour with it, it will operate for a number of " +
                                 "hours equal to your LOG check. If you spend a day with it, it will operate for a " +
                                 "number of days equal to your LOG check."},
                        {'Name': 'Upgrade',
                         'Desc': "You can modify a piece of electronic equipment of size Small or smaller to upgrade " +
                                 "it permanently to a high quality item. This process takes one hour, but the item " +
                                 "can only be used by you due to unfamiliar and jury-rigged controls, and renders it " +
                                 "monetarily worthless."},
                        {'Name': 'Engine-tuner',
                         'Desc': "A vehicle to which you have an hour's access increases its maximum speed by 1. This " +
                                 "does not stack with other engineers should others be present."},
                        {'Name': 'Engine-master [requires Engine-tuner]',
                         'Desc': "You can increase your vehicle's speed by 2 for a number of hours equal to your LOG " +
                                 "check, after which the engine cannot be used for 24 hours. This does not stack with " +
                                 "other engineers should others be present."},
                        {'Name': 'Explosives',
                         'Desc': "You can create explosives from common items and surroundings. The explosive takes " +
                                 "30 minutes to make, and causes 3d6 heat damage to all within 5'. The explosive can " +
                                 "be stored, but only for up to two hours."},
                        {'Name': 'Saboteur',
...
var career_now_explosives_expert = new Career(
    ...
    available_exploits=[{'Name': 'Home-cooking',
                        ...
                        {'Name': 'Booby-trapping',
                         'Desc': "Using a home-cooked device (made as above), a grenade, or similar explosive, " +
                                 "you can rig a door, trunk, or object to explode when opened or at a specific time. " +
                                 "This takes 2 actions and is obvious. By spending 5 minutes you can hide it; anyone " +
                                 "activating it gets an opposed check (their INT vs. your AGI) to notice the trap " +
                                 "before it is set off."},
                        {'Name': 'Boom-boom',
                         'Desc': "Explosive devices, such as grenades, do +!d6 damage when you use them."},
                        {'Name': 'Shaped charge',
                         'Desc': "You know exactly how to target explosives. You may direct any area of effect attack " +
                                 "with a radius so that it explodes in a cone in a single direction. The cone size is " +
                                 "equal to the diameter (not radius) of the original explosion, so a 5' radius " +
                                 "explosion can be directed into a 10' cone."},
                        {'Name': 'Disarm bomb',
                         'Desc': "If you have a minute to spare, you can disarm any explosive device. If it is timed, " +
                                 "it dramatically happens at the last second."},
                        {'Name': 'Duck-and-cover',
                         'Desc': "You know how to avoid damage from explosives and similar effects. You take half " +
...
var career_now_firefighter = new Career(
    ...
    available_exploits=[{'Name': 'Fire-resistant',
                         'Desc': "You've been through many fires, and have developed a resistance to it. You gain " +
                                 "natural SOAK 5 (heat)."},
                        {'Name': 'Ladder-climber',
                         'Desc': "You spend a lot of time climbing ladders, broken stairs, even drainpipes and walls. " +
                                 "You gain a CLIMB speed equal to your regular SPEED."},
                        {'Name': "Fireman's lift",
                        ...
                        {'Name': 'Hold breath',
                         'Desc': "Like a swimmer, you have learned to hold your breath; in your case it's so that you " +
                                 "do not inhale noxious fumes or smoke. You can hold your breath for one minute per " +
                                 "point of INT."},
                        {'Name': 'Extinguish',
...
var career_now_guerrilla_fighter = new Career(
    ...
    available_exploits=[{'Name': 'Ambush expert', 'Desc': "During an ambush turn you can take a second action."},
                        ...
                        {'Name': 'Hit-and-run',
                         'Desc': "You can move from out of line of sight, into firing position, make an attack " +
                                 "action, and then back to out of line of sight twice per day."},
                        {'Name': 'Always read',
                         'Desc': "Sleep in armor with no penalty. Anyone sneaking up on you while you sleep must make " +
                                 "a Difficult [16] AGI check to do so."},
                        {'Name': 'Sabotage',
...
var career_now_hacker = new Career(
    ...
    available_exploits=[{'Name': 'Hacking rig',
                         'Desc': "You gain a high quality laptop or portably computer designed for hacking on the " +
                                 "move."},
                        {'Name': 'Red lights',
                         'Desc': "(requires Hacking Rig) You can use your hacking rig to change traffic lights to any " +
                                 "configuration you wish."},
                        {'Name': 'Bank job', 'Desc': "A virtual bank job gains you $1,000 and +1 REP."},
                        {'Name': 'City hall',
                         'Desc': "You can hack into security agencies, including the police and intelligence " +
                                 "agencies, to gain information about any individual whose name you know, " +
                                 "assuming those agencies have that information. This takes you one hour."},
...
var career_now_heavy_gunner = new Career(
    ...
    available_exploits=[{'Name': 'Lay down fire',
                        ...
                        {'Name': "This ain't heavy.",
                         'Desc': "Choose one heavy weapon; when you carry one of these weapons, it does not count " +
...
var career_now_laborer = new Career(
    ...
    available_exploits=[{'Name': 'Jack-of-all-trades',
                        ...
                        {'Name': 'Danger pay',
                         'Desc': "Some work is dangerous. Perhaps you worked high on a skyscraper or cleaned toxic " +
                                 "waste. You gain $1,000 bonus money and +1 REP."},
                        {'Name': 'Union',
                         'Desc': "You were a member of a union. Your pay is higher (gain +2 REP) and you gain 1 rank " +
                                 "(1d6) in law and bureaucracy."},
                        {'Name': "Worker's clothes",
                         'Desc': "Over the years you have patched together a \"uniform\" of sorts which protects you " +
                                 "from hazards - hardhat, goggles, high strength clothing, gloves, sturdy boots, " +
...
var career_now_lawyer = new Career(
    ...
    available_exploits=[{'Name': 'Get out of jail free',
                        ...
                        {'Name': 'Court records',
                         'Desc': "You have access to court records, and can look up the criminal record of any named " +
                                 "individual given an hour's notice and a computer connection (or physical access to " +
                                 "the courthouse)."},
                        {'Name': 'Orator',
                         'Desc': "You can be very persuasive, and know how to bend a jury or other group of people to " +
                                 "your point of view. You can influence up to 12 people within 30' with a 15-minute " +
                                 "speech. Make a CHA mental attack; if successful, the group moves one stage along " +
                                 "the Charm status track."},
                        {'Name': 'Ambulance-chaser',
                         'Desc': "You spent time making money the only way you could. You start play with $1," +
                                 "000 extra money."},
                        {'Name': 'Crusader.',
...
var career_now_medic = new Career(
    ...
    available_exploits=[{'Name': 'Medical knowledge base',
                         'Desc': "Choose four [medical] skills. You gain these four skills at 1 rank (1d6). This does " +
                                 "not increase the rank of an existing skill."},
                        {'Name': 'Bedside manner',
                         'Desc': "You gain a medical kit. Your long-term care is of such quality that your patient " +
                                 "gains an additional 1d6 HEALTH per day. You may only have one patient under your " +
                                 "long-term care at a time."},
                        {'Name': 'Consultant (requires Doctorate',
                         'Desc': ". You are a highly paid consultant doctor. Your REP increases by 2 and you start " +
                                 "play with a bonus $1,000."},
                        {'Name': 'Ward management [requires Bedside Manner].',
                         'Desc': "You are an expert at running and managing a ward or sickbay. The number of patients " +
                                 "you can have under your long-term care is increased to the value of your LOG " +
                                 "attribute."},
                        {'Name': 'Diagnosis',
                         'Desc': "You gain +1d6 bonus to identify or treat diseases. Make a Difficult [16] LOG check " +
                                 "before advancing any attributes. If you succeed, you discovered a new disease or " +
                                 "illness which is named after you; you also gain 1 bonus REP attribute point."},
                        {'Name': 'Healing hands',
                         'Desc': "Using basic medical equipment, you can heal 1d6 points of HEALTH to an adjacent " +
                                 "creature as a single action. Any given creature can only benefit from your healing " +
                                 "in this way once per day."},
                        {'Name': 'Exceptional healing hands [requires Healing Hands]',
                         'Desc': "Your Healing Hands ability increases to 2d6 points of HEALTH."},
                        {'Name': 'Psychologist',
                         'Desc': "An expert in matters of the mind, you gain +2 MENTAL DEFENSE and once per day you " +
                                 "can automatically remove a mental (WIL-based) status track from yourself or an " +
                                 "adjacent ally by spending two actions."},
...
var career_now_miner = new Career(
    ...
    available_exploits=[{'Name': 'Underground sense',
                         'Desc': "When underground you can always determine direction and depth and pick a route to " +
                                 "the surface."},
                        {'Name': 'Darksight',
                         'Desc': "You have spent so much time below ground that you've developed darksight to a " +
                                 "distance of 30'."},
                        {'Name': 'Mining hazards',
...
var career_now_ninja = new Career(
    ...
    available_exploits=[{'Name': 'Poison',
                        ...
                        {'Name': 'Gas poison (requires Poison).',
                         'Desc': "By spending an action, you can deliver your poison as a dust or small burst of gas " +
                                 "that ignores the target's SOAK. You can throw this with a range increment of 2."},
                        {'Name': 'Weapon master',
                         'Desc': ". You can draw and sheathe a sword, staff, club, spear, naginata, kusarigama, " +
                                 "and shuriken as a free action. Choose one of these weapons; you receive a +1d6 to " +
                                 "damage with this weapons."},
                        {'Name': 'Death strike',
                         'Desc': "Once per day you may strike a creature that is not aware of your presence or does " +
                                 "not realize you are an enemy with surprising, lethal force. Make an attack roll " +
...
var career_now_performer = new Career(
    ...
    available_exploits=[{'Name': 'Triple-threat',
                        ...
                        {'Name': 'Gig',
                         'Desc': ". You can make money by playing at bars and doing local performances. You can " +
                                 "automatically make an amount equal to a CHA check x $10 per day by doing this. This " +
                                 "exploit cannot be used during downtime."},
                        {'Name': 'Captivating',
                         'Desc': "You have the ability to captivate people with your musical ability. While using " +
                                 "your musical instrument or voice, all those who can hear you become beguiled (" +
                                 "unable to attack you) until you stop. This requires a CHA vs. MENTAL DEFENSE check " +
                                 "and a full two actions each turn."},
                        {'Name': 'Lullaby',
                         'Desc': "Your music and make people drowsy. While using your musical instrument or voice, " +
                                 "all those who can hear you become weary (-1d6 to all physical attribute checks and " +
                                 "-1 SPEED) until you stop. This requires a CHA vs. MENTAL DEFENSE check and a full " +
    ...
    available_exploits=[{'Name': 'Push the limits', 'Desc': "You can exceed an aircraft's normal maximum SPEED by 2."},
                        {'Name': 'Evasive flying',
                         'Desc': "An aircraft which you pilot gains a DEFENSE bonus equal to your AGI attribute dice " +
                                 "pool."},
                        {'Name': 'Cruise control',
                         'Desc': "You are able to easily navigate without an attribute check."},
                        {'Name': 'Evasive maneuver [requires Evasive Flying]',
                         'Desc': "As an action, you may designate one incoming missile per round and gain an " +
...
var career_now_police_officer = new Career(
    ...
    available_exploits=[{'Name': 'Troublesense',
                         'Desc': "You are easily able to spot trouble before it happens. You gain a +1d6 bonus to " +
                                 "INITIATIVE checks."},
                        {'Name': 'Out of place',
                         'Desc': "You know the signs of suspicious behavior. You gain a +1d6 bonus to checks made to " +
                                 "spot unusual or criminal activity."},
                        {'Name': 'Freeze!',
                         'Desc': "You can compel a target to “freeze!” with a CHA vs. MENTAL DEFENSE check. If " +
                                 "successful, the target stops in his tracks and is stunned until he shakes that " +
                                 "condition off. The target must be able to understand you and have an INT attribute " +
                                 "of 3 or more. You can only do this to a given target once."},
                        {'Name': 'Backup',
                         'Desc': "In an allied urban environment, you can call for backup once per day in the form of " +
                                 "1d6 police officers who arrive within 5 minutes and who will follow your orders."},
...
var career_now_politician = new Career(
    ...
    available_exploits=[{'Name': 'Corruption',
                         'Desc': "Not all politicians are corrupt, but you succumbed to temptation. You start play " +
                                 ...
                                 "this exploit during character creation, and only if this is not your last career."},
                        {'Name': 'Idealist',
                         'Desc': "You have a platform of ideology, and this gives you great mental strength. You gain " +
                                 "+2 MENTAL DEFENSE. Decide what you ideological platform is."},
                        {'Name': 'Local elections',
                         'Desc': "You won a local election and started representing your community. You gain +1 REP. " +
                                 "You can make a REP mental attack against a target within 30' to push them one stage " +
                                 "down the Charm status track."},
                        {'Name': 'Regional elections (requires Local Elections).',
                         'Desc': "You won a regional election and represented the greater community. You gain +2 REP. " +
                                 "Your REP attack to influence people can now affect a number of people equal to your " +
                                 "CHA score."},
                        {'Name': 'Public speaker',
...
var career_now_priest = new Career(
    ...
    available_exploits=[{'Name': 'Confessional.',
                        ...
                        {'Name': 'Unshakeable faith',
                         'Desc': "You have faith, a peace of mind and an inner tranquillity which is hard to " +
                                 "penetrate. You gain +5 to your MENTAL DEFENSE."},
                        {'Name': 'Respect',
...
var career_now_private_eye = new Career(
    ...
    available_exploits=[{'Name': 'Snoop',
                         'Desc': "You've got a good sense of when something just isn't quite right; once per day when " +
                                 ...
                                 "and 2."},
                        {'Name': 'Contacts',
                         'Desc': "You have a contact in the police force who can conduct routine checks (background, " +
                                 "number plates, etc.) for you."},
...
var career_now_reporter = new Career(
    ...
    available_exploits=[{'Name': 'Discern lie', 'Desc': "You always know when somebody is lying to you."},
                        ...
                        {'Name': 'Research skills',
                         'Desc': "You gain 3 ranks in computers, journalism, and one skill from a choice of law, " +
                                 "politics, or economics."},
                        {'Name': 'Big scoop',
                         'Desc': "You uncovered a big secret, and revealed it in the news. Decide what this scoop " +
                                 "was. You gain +2 REP. Roll 1d6; on a 6 you won a Pulitzer Prize for it. You may " +
                                 "take this exploit mltiple times."},
                        {'Name': 'Contact',
                         'Desc': "You have a contact in the police force, mayor's office, or similar body. You can " +
                                 "call on this contact for information once per month. You may take this exploit " +
                                 "multiple times, gaining a new contact each time."},
                        {'Name': 'Tabloid hack',
...
var career_now_sailor = new Career(
    ...
    available_exploits=[{'Name': 'Any Port',
                        ...
                        {'Name': 'Lookout',
                         'Desc': "Lookout duty is a mandatory part of a sailor's life. You gain +1d6 to perception " +
                                 "checks."},
                        {'Name': 'Sea Legs',
...
var career_now_scientist = new Career(
    ...
    available_exploits=[{'Name': 'Scientific knowledge base',
                         'Desc': "Choose four [scientific] skills. You gain these four skills at 1 rank (1d6). This " +
                                 "does not increase the rank of an existing skill."},
                        {'Name': 'Analytical eye',
                         'Desc': "You are able to identify the resistances, immunities, and vulnerabilities of any " +
                                 "creature you can see with a Difficult [16] LOG check. This requires two full " +
                                 "actions of observation."},
                        {'Name': 'Improviser',
                         'Desc': "In the field, you need to improvise. Using your scientific know-how, you can create " +
                                 "a crude object or device from your surroundings. This requires a LOG check, " +
                                 "with a difficulty value equal to the purchase value of the object, and takes 30 " +
                                 "minutes."},
...
var career_now_sensei_sifu = new Career(
    ...
    available_exploits=[{'Name': 'Inspiring',
                        ...
                        {'Name': 'Teacher',
                         'Desc': "You are able to \"lend\" somebody one rank in a skill for up to one day. Only one " +
                                 "person at a time can benefit from this ability."},
                        {'Name': 'Heirloom weapon', 'Desc': "You gain one high quality Eastern weapon."},
                        {'Name': 'Protégé',
                         'Desc': "(requires Inspiring and Teacher) You gain a protégé. This is a martial artist who " +
                                 "has half your grade. The protégé accompanies you and assists you. If your protégé " +
                                 "dies, you must take this exploit again in order to replace him or her. You may only " +
                                 "have one protégé at a time."},
                        {'Name': 'First-aid',
...
var career_now_smuggler = new Career(
    ...
    available_exploits=[{'Name': 'Smuggle',
                        ...
                        {'Name': 'Haggler.',
                         'Desc': "You're a born haggler, and can reduce the cost of any purchase by 3d6%. This does " +
                                 "not stack with any other exploits which reduce purchase costs."},
                        {'Name': 'Fence',
...
var career_now_soldier = new Career(
    ...
    available_exploits=[{'Name': 'Battle scars',
                        ...
                        {'Name': 'Quick naps',
                         'Desc': "You've learned to manage with little sleep. As long as you get 4 hours, " +
                                 "you count as fully rested."},
                        {'Name': 'Get on with it.',
                         'Desc': "Your platoon doesn't have much patience for whining about minor injuries. Once per " +
                                 "day you can pause for two actions and recover 2d6 HEALTH."},
                        {'Name': 'Shake it off.',
...
var career_now_spy = new Career(
    ...
    available_exploits=[{'Name': 'False identify',
                        ...
                        {'Name': 'Off the grid',
                         'Desc': "You know how to disappear without trace, dropping off the grid completely. No " +
                                 "location discerning checks or abilities can find you unless you want them to."},
                        {'Name': 'Safe house',
                         'Desc': "(requires Off the Grid) You can use a safe house on any populated planet to grant " +
                                 "your off the grid ability to your entire party."},
                        {'Name': 'Monologue',
                         'Desc': "Once per day you can make a CHA vs. MENTAL DEFENSE attack against an enemy. If " +
                                 "successful, your target explains their plan with a short monologue."},
                        {'Name': 'Miraculous escape',
                         'Desc': "Once per day you may automatically succeed in one attempt to escape handcuffs or " +
                                 "other restraints."},
                        {'Name': 'Q-Branch',
    ...
    available_exploits=[
        ...
        {'Name': 'Mentor',
         'Desc': "One of your teachers is a mentor to you. Choose one skill. He or she has 10 ranks (4d6) in that " +
                 "skill and will use it to assist you."},
        {'Name': 'Wrong crowd',
...
var career_now_stuntman = new Career(
    ...
    available_exploits=[{'Name': 'Broken every bone',
                         'Desc': "You've broken most every bone in your body at one time or the other. You gain " +
                                 "natural SOAK 5."},
                        {'Name': 'Fast-healer',
                         'Desc': "You need to heal fasts to make it in the stuntman business. When you roll for " +
                                 "natural healing each day, add an extra 2d6."},
                        {'Name': 'Patched up',
                         'Desc': "Once per day you can patch yourself up, recovering 2d6 HEALTH. This takes two " +
                                 "actions."},
...
var career_now_survivalist = new Career(
    ...
    available_exploits=[{'Name': 'Spot poison',
                        ...
                        {'Name': 'Poison resistance',
                         'Desc': "You gain SOAK (5) to poison. If you take this exploit a second time it increases to " +
                                 "SOAK 10. A third time, you become immune to poisons."},
                        {'Name': 'Animal knowledge',
                         'Desc': "You know a lot about animals. You automatically know the vulnerabilities and " +
                                 "abilities of any creature of the beast creature type."},
                        {'Name': 'Move without trace',
                         'Desc': "You know how not to leave tracks. You gain +1d6 to stealth checks related to " +
                                 "tracking and the avoidance of it, and to avoid non-visual animal senses such as " +
                                 "scent."},
...
var career_now_teacher = new Career(
    ...
    available_exploits=[{'Name': 'Advice',
                        ...
                        {'Name': 'Textbook',
                         'Desc': "You may choose any skill. You have a textbook about that subject on you. You have " +
                                 "that skill at the same number of ranks as your LUC score. You may change your " +
                                 "textbook and switch to a different skill by visiting a library, bookstore, " +
                                 "or other source of books. This may not be a skill you use a physical attribute (" +
                                 "STR, AGI, END) with."},
                        {'Name': 'Professor',
...
var career_now_vigilante = new Career(
    ...
    available_exploits=[{'Name': 'Inside contacts',
                         'Desc': "You know people who know people who know people. You might have a reliable ear in " +
                                 ...
                                 "make a Challenging [13] INT check to learn valuable information about a specific " +
                                 "target. For every stage you exceed the minimum check, you learn one more piece of " +
                                 "information about the target; for example, an INT check result of 16 would tell you " +
                                 "two pieces of information, an INT check result of 21 would tell you three pieces of " +
                                 "information, and so on."},
                        {'Name': 'My city',
                         'Desc': "Choose a city or other area. In that area, you receive +1d6 on checks made to hide " +
                                 "or move quietly while there."},
                        {'Name': 'Iconic vehicle',
                         'Desc': "If you possess a vehicle, it gains two enhancements. If you don't yet have one, " +
...
var career_now_warrior_monk = new Career(
    ...
    available_exploits=[{'Name': 'Defensive Stance',
                        ...
                        {'Name': 'Drunken Fist',
                         'Desc': "When intoxicated through alcohol, you gain +4 to both your MELEE and RANGED " +
                                 "DEFENSE. This does not stack with Defensive Stance."},
                        {'Name': 'Elemental Fist',
                         'Desc': "(requires Iron Fist, CHI 2+) Your fist is surrounded by the glow of elemental " +
                                 "energy. The damage type becomes heat, and does an additional +1d6 damage."},
                        {'Name': 'Iron Fist',
                         'Desc': "Your unarmed damage increases by 1d6. This does not stack with other exploits or " +
                                 "equipment which increase your unarmed damage, except for Elemental Fist."},
