var career_ma_aikido = new Career({
    ...
    available_exploits: [{'Name': "Curriculum exploits",
                        ...
                        {'Name': "Reactive lock",
                         'Desc': "(requires Arm Lock) You may may use the Arm Lock exploit to make an attack as a " +
                                 "reaction when an attacker misses you with a melee attack."},
    ...
    available_exploits: [
        ...
        {'Name': "Momentous knockdown",
         'Desc': "(requires Knockdown)  You do not pay a dice cost to perform the Knockdown exploit; however both you " +
                 "and the target are prone after a successful attempt."},
        {'Name': "Forced submission",
         'Desc': "(requires Arm Lock)  If both you and your target are prone, and you have successfully applied an " +
                 "Arm Lock, you may make a melee attack against his MENTAL DEFENSE to force him to submit. If " +
...
var career_ma_capoeira = new Career({
    ...
    available_exploits: [{'Name': "Curriculum exploits",
                        ...
                        {'Name': "Asymmetric advantage",
                         'Desc': "If you are engaged in melee with two or more opponents, you gain +1d6 to attack for " +
                                 "every two opponents actively engaging you in melee combat. In other words, " +
                                 "if you are being attacked by four foes, you gain +2d6 to attack."},
                        {'Name': "Rasteira",
                         'Desc': "(requires Trip) If an adjacent enemy makes a movement action, you may take a trip " +
                                 "attack against them as a reaction."},
                        {'Name': "Asymmetric adept",
                         'Desc': "(requires Asymmetric advantage) For every foe past the first, you gain +1 MELEE " +
                                 "DEFENSE."},
                        {'Name': "Roda",
    ...
    available_exploits: [{'Name': "Rapid reload",
                        ...
                        {'Name': "Sliding fusillade",
                         'Desc': "For two actions, you can take your full movement in a straight line and make up to " +
                                 "two attack actions."},
                        {'Name': "Firing forms",
                         'Desc': "By spending all of your actions, you can take as many attack actions as there are " +
                                 "targets, up to your INT attribute. You may only fire at a given target once, " +
                                 "and each cumulative shot beyond the first takes a -1d6 penalty."},
                        {'Name': "Leaping ballistics",
                         'Desc': "When you perform a jump, you may make one gun attack for free."},
                        {'Name': "Curved bullet",
                         'Desc': "You may spend a LUC die to curve a bullet round a corner once per round, " +
                                 "effectively negating your target's cover. You must still have line of sight; this " +
                                 "ability negates cover, but does not create new lines of sight."},
                        {'Name': "Cover me!",
                         'Desc': "Any sidearm you use automatically gains the auto trait, making it especially " +
...
var career_ma_gun_kata = new Career({
    ...
    available_exploits: [{'Name': "Gunpunch",
                         'Desc': "Once per round, while holding a sidearm, your martial arts attack does the damage " +
                                 "of your gun."},
                        {'Name': "Multipunch",
                         'Desc': "(requires Gunpunch) If you are dual-wielding pistols, all of your martial arts " +
                                 "attacks do the damage of your gun."},
                        {'Name': "Closedown",
                         'Desc': "When attacked by somebody with a gun 10' or less away from you, you immediately " +
                                 "move adjacent to them and perform a martial arts attack as a reaction."},
                        {'Name': "Bulletcatcher",
                         'Desc': "Once per turn as a reaction you can catch a single bullet fired at you as long as " +
                                 "you are aware of the attack. This does not help against weapons with the auto " +
                                 "trait."},
...
var career_ma_jujutsu = new Career({
    ...
    available_exploits: [{'Name': "Curriculum exploits",
                        ...
                        {'Name': "Fluid resistance",
                         'Desc': "Once per turn, after taking damage from a melee attack, you automatically make a " +
                                 "counterattack as a reaction."},
                        {'Name': "Reactive disarm",
                         'Desc': "(requires Disarm) Once per turn, after a melee attack misses you, you automatically " +
                                 "make a reactive attack which, if successful, disarms your attacker."},
...
var career_ma_karate = new Career({
    ...
    available_exploits: [{'Name': "Curriculum exploits",
                         'Desc': "Choose any three hard exploits from the Universal Exploits for Martial Artists " +
                                 "sidebar."},
                        {'Name': "Wax On, Wax Off",
                         'Desc': "You develop patience while performing rote training tasks. You gain +2 MELEE " +
                        ...
                        {'Name': "Crane stance",
                         'Desc': "You adopt a stance by spending an action. You cannot move while in this stance. If " +
                                 "any foe attempts to engage you melee combat, you gain a free attack as a reaction " +
                                 "against him. This attack takes place before your foe's attack. Once you have made " +
                                 "this attack, your stance ends."},
                        {'Name': "Double punch",
                         'Desc': "You may use one action to make two unarmed attacks against a single foe. You may " +
...
var career_ma_krav_maga = new Career({
    ...
    available_exploits: [{'Name': "Curriculum exploits",
                         'Desc': "Choose any three hard exploits from the Universal Exploits for Martial Artists " +
                                 "sidebar."},
                        {'Name': "Know the arena",
                         'Desc': "In any location, you automatically note any non-hidden exits from the vicinity. You " +
                                 "are easily able to improvise weapons using your surroundings–glasses, rocks, " +
                                 "and so on; you always count as carrying a knife or club."},
                        {'Name': "Brutal counter",
                         'Desc': "After an enemy makes a successful melee attack on you, you gain +1d6 damage in " +
                                 "melee against that foe. If any other enemy strikes you, your bonus damage switches " +
                                 "to that target."},
                        {'Name': "Weak points",
                         'Desc': "You are adept at targeting weak or vulnerable points in your foes, and can ignore " +
                                 "SOAK by spending one LUC die."},
...
var career_ma_kung_fu = new Career({
    ...
    available_exploits: [{'Name': "Curriculum exploits",
                         'Desc': "Choose any two hard or soft exploits from the Universal Exploits for Martial " +
                                 "Artists sidebar."},
                        {'Name': "One-inch punch",
                         'Desc': "When pinned or grappled, you may make an unarmed attack against your foe as a free " +
                                 "action and gain +1d6 damage to it."},
                        {'Name': "Double strike",
                         'Desc': "With one action you may strike two opponents with a melee attack each. You cannot " +
                                 "add additional exploits to these attacks."},
                        {'Name': "Sticking hands",
                         'Desc': "You remain in constant contact with your foe's arms and hands, allowing you to " +
                                 "easily deflect attacks and counter. You gain +2 MELEE DEFENSE against one adjacent " +
                                 "opponent, and may counterstrike with a basic (no additional exploits) unarmed " +
                                 "attack against that foe as a reaction to any missed attack."},
                        {'Name': "Active resistance",
                         'Desc': "Once per day, spend an action to prepare and gain SOAK to one type of damage equal " +
...
var career_ma_muay_thai = new Career({
    ...
    available_exploits: [{'Name': "Curriculum exploits",
                        ...
                        {'Name': "Thip",
                         'Desc': "You make a devastating kick; on a successful hit, instead of dealing damage the " +
                                 "target is dazed until they shake the condition off."},
                        {'Name': "Chok-te",
                         'Desc': "Gain a cumulative +1d6 to attack every time you make an unarmed attack which " +
                                 "misses. Once an attack hits, your bonus resets to zero."},
...
var career_ma_northern_shaolin = new Career({
    ...
    available_exploits: [{'Name': "Curriculum exploits",
                        ...
                        {'Name': "Rolling defense",
                         'Desc': "(requires Roll With It) When you use the Roll With It combat exploit you finish the " +
                                 "maneuver standing."},
                        {'Name': "CHI healing",
...
var career_ma_pankration = new Career({
    ...
    available_exploits: [{'Name': "Curriculum exploits",
                         'Desc': "Choose any three soft exploits from the Universal Exploits for Martial Artists " +
                                 "sidebar."},
                        {'Name': "Olympic stance",
                         'Desc': "Spend 1 action to enter an Olympic stance. While in an Olympic stance your movement " +
                                 "is halved, but you gain +4 MELEE DEFENSE."},
                        {'Name': "Straight kick",
                         'Desc': "You make a devastating kick; on a successful hit, instead of dealing damage the " +
                                 "target is sickened until they shake the condition off."},
                        {'Name': "Great bear",
...
var career_ma_savate = new Career({
    ...
    available_exploits: [{'Name': "Curriculum exploits",
                         'Desc': "Choose any three hard exploits from the Universal Exploits for Martial Artists " +
                                 "sidebar."},
                        {'Name': "Assault savate",
                         'Desc': "Increase your jump distance by 50%. With a successful attack you may feint an " +
                                 "opponent, just barely touching them and steal or place one small item, " +
                                 "like a playing card or wallet, on their person without their notice."},
                        {'Name': "Pre-combat savate",
                         'Desc': "Any turn that you jump, add +2d6 damage to any attack you make as you land. You " +
                                 "must jump more than 5’ to gain this bonus."},
                        {'Name': "Combat savate",
                         'Desc': "When you take damage from a melee attack, you may take the blow’s momentum and use " +
                                 "it to your advantage, gaining an attack bonus equal to the damage caused to the " +
...
var career_ma_southern_shaolin = new Career({
    ...
    available_exploits: [{'Name': "Curriculum exploits",
                         'Desc': "Choose any three hard exploits from the Universal Exploits for Martial Artists " +
                                 "sidebar."},
                        {'Name': "Empty hand",
                         'Desc': "Whenever you successfully perform a Disarm combat exploit, instead of the target " +
                                 "dropping its weapon, you take it in hand and may make one free attack with it on " +
                                 "the target."},
                        {'Name': "Godfist",
                         'Desc': "(requires Knockback) When you use the Knockback combat exploit, you double the " +
                                 "distance a target is moved. The target becomes stunned until they shake the " +
                                 "condition off."},
