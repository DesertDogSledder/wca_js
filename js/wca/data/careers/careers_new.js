var career_new_academy = new Career(
    name='Academy',
    career_time='3',
...
var career_new_assassin = new Career(
    name='Assassin',
    career_time='1d6',
    career_time_unit='years',
...
var career_new_athlete = new Career(
    name='Athlete',
    career_time='1d6',
    career_time_unit='years',
...
var career_new_bartender = new Career(
    name='Bartender',
    career_time='1d6',
    career_time_unit='years',
    prerequisites='none',
...
var career_new_battlepsyche = new Career(
    name='Battlepsyche',
    career_time='1d6',
    career_time_unit='years',
...
var career_new_biopsychic = new Career(
    name='Biopsychic',
    career_time='1d6',
    career_time_unit='years',
...
var career_new_bounty_hunter = new Career(
    name='Bounty Hunter',
    career_time='1d6',
    career_time_unit='years',
    prerequisites='none',
...
var career_new_burglar = new Career(
    name='Burglar',
    career_time='1d6',
    career_time_unit='years',
...
var career_new_college = new Career(
    name='College',
    career_time='4',
    career_time_unit='years',
    prerequisites='none',
...
var career_new_con_artist = new Career(
    name='Con Artist',
    career_time='1d6',
    career_time_unit='years',
...
var career_new_craftsman = new Career(
    name='Craftsman',
    career_time='1d6',
    career_time_unit='years',
...
var career_new_detective = new Career(
    name='Detective',
    career_time='1d6',
    career_time_unit='years',
    prerequisites='none',
...
var career_new_diplomat = new Career(
    name='Diplomat',
    career_time='1d6',
    career_time_unit='years',
...
var career_new_drifter = new Career(
    name='Drifter',
    career_time='1d6',
    career_time_unit='years',
    prerequisites='none',
...
var career_new_engineer = new Career(
    name='Engineer',
    career_time='1d6',
    career_time_unit='years',
...
var career_new_gambler = new Career(
    name='Gambler',
    career_time='1d6',
    career_time_unit='years',
...
var career_new_gangster = new Career(
    name='Gangster',
    career_time='1d6',
    career_time_unit='years',
...
var career_new_intelligence_officer_spy = new Career(
...
var career_new_marine_cadet_assignment = new Career(
...
var career_new_marine_tour = new Career(
    name='Marine Tour',
    career_time='1d6',
    career_time_unit='years',
    prerequisites='none',
...
var career_new_medic = new Career(
    name='Medic',
    career_time='1d6',
    career_time_unit='years',
    prerequisites='medicine',
...
var career_new_miner = new Career(
    name='Miner',
    career_time='1d6',
    career_time_unit='years',
    prerequisites='none',
...
var career_new_navy_cadet_cruise = new Career(
...
var career_new_navy_tour = new Career(
    name='Navy Tour',
    career_time='1d6',
    career_time_unit='years',
    prerequisites='none',
...
var career_new_performer = new Career(
    name='Performer',
    career_time='1d6',
    career_time_unit='years',
...
var career_new_pilot = new Career(
    name='Pilot',
    career_time='1d6',
    career_time_unit='years',
...
var career_new_police_officer = new Career(
    name='Police Officer',
    career_time='1d6',
    career_time_unit='years',
    prerequisites='none',
...
var career_new_priest = new Career(
    name='Priest',
    career_time='1d6',
    career_time_unit='years',
...
var career_new_prisoner = new Career(
    name='Prisoner',
    career_time='2d6',
    career_time_unit='years',
    prerequisites='none',
...
var career_new_psi_cop = new Career(
    name='Psi-cop',
    career_time='1d6',
    career_time_unit='years',
    prerequisites='law',
...
var career_new_psychic = new Career(
    name='Psychic',
    career_time='1d6',
    career_time_unit='years',
    prerequisites='none',
...
var career_new_scientist = new Career(
    name='Scientist',
    career_time='1d6',
    career_time_unit='years',
...
var career_new_scout_special_forces = new Career(
...
var career_new_smuggler = new Career(
    name='Smuggler',
    career_time='1d6',
    career_time_unit='years',
    prerequisites='piloting',
...
var career_new_sniper = new Career(
    name='Sniper',
    career_time='1d6',
    career_time_unit='years',
...
var career_new_socialite = new Career(
    name='Socialite',
    career_time='1d6',
    career_time_unit='years',
    prerequisites='[social]',
...
var career_new_space_jockey = new Career(
    name='Space Jockey',
    career_time='1d6',
    career_time_unit='years',
    prerequisites='none',
...
var career_new_spartan_battle_school = new Career(
...
var career_new_starbase_assignment = new Career(
...
var career_new_star_knight = new Career(
    name='Star Knight',
    career_time='1d6',
    career_time_unit='years',
...
var career_new_street_thug = new Career(
    name='Street Thug',
    career_time='1d6',
    career_time_unit='years',
    prerequisites='none',
...
var career_new_systems_upgrade = new Career(
...
var career_new_trader = new Career(
    name='Trader',
    career_time='1d6',
    career_time_unit='years',
    prerequisites='none',
...
var career_new_venetian_retreat = new Career(
...
var career_new_list = [career_new_academy, career_new_assassin, career_new_athlete, career_new_bartender,
